...
Define how `@deandre-dock/buttons` delivers its CSS styles to consuming applications — specifically, that styles inject automatically on import so consumers never need a manual CSS import step.
